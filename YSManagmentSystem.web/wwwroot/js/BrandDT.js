            ...
            columns: [
...

                {
                    data: "id", "render": function (data, type, row) {
                        return '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" href="" data-url="/Brand/AddOrEditBrand?id=' + data + '" > <i class="fa fa-edit"></i></button>  <a href="#" class="btn btn-danger" onclick=DelBrand("' + data + '")><i class="fa fa-trash"></i></a>'
                    },
                    "Width": "autowidth"
                }
            ],
        ...
        if (result.isConfirmed) {
            {
                $.ajax({
                    type: "POST",
                    url: '@Url.Content("~/")' + "Brand/DeleteBrand" / + id,
...
//}
//function Delete(id) {
//    var url = '@Url.Content("~/")' + "Brand/DeleteBrand";

//    $.post(url, { ID: id }, function (data) {
//        if (data) {
//            oTable = $('#myTableBrand').DataTable();
//            oTable.draw();
//        } else {
