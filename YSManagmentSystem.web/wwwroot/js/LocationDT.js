            ...
            columns: [
...

                {
                    data: "id", "render": function (data, type, row) {
                        return '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" href="" data-url="/Location/AddOrEditLocation?id=' + data + '" > <i class="fa fa-edit"></i></button>  <button href="#" class="btn btn-danger" onclick=DelLoc("' + data + '")><i class="fa fa-trash"></i></button>'
                    },
                    "Width": "autowidth"
                }
            ],
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == 200) {
                        ...
                        $('#myTableLocation').DataTable().ajax.reload();
        ...
        if (result.isConfirmed) {
            {
                $.ajax({
                    type: "POST",
                    url: '@Url.Content("~/")' + "Location/DeleteLocation"/ + id,
